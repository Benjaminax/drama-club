            ...
            {(content.productions || []).map((p, i) => {
              ...
              return (
                <Link
                  ...
                  to={`/projects/${i}`}
                  data-reveal="up"
                  className="bg-stone-900/60 flex flex-col backdrop-blur-md rounded-2xl hover:bg-stone-900/80 transition-all card-hover border border-amber-900/20 shadow-xl group overflow-hidden relative h-full cursor-pointer"
                >
                  {p.image && (
                  ...
                  <div className="p-7 flex-1 flex flex-col relative z-10">
                    ...
                    <p className="text-yellow-500 text-xs mt-4 font-medium">
                      {hasContent ? 'Read more →' : 'View details →'}
                    </p>
